...
/**
 * Clase ejecutable que mostrara al usuario el arreglo
 *  con precios de los objetos del arreglo electrodomesticos.
...
public class Ejecutable {
	...
	public static void main(String[] args) {
		...
		/**
		 * Arreglo de electrodomesticos el cual incluye
		 * objetos de tipo Televisor, Electrodomestico y
		 * Lavadora.
		 */
		Electrodomestico electrodomesticos[] = new Electrodomestico[10];
		electrodomesticos[0] = new Televisor(50, false,
							   100000, 6, "blanco", 'A');
		electrodomesticos[1] = new Electrodomestico(100000, 50,
							   "gris", 'L');
		electrodomesticos[2] = new Televisor(25, true, 100000, 3,
					           "verde", 'D');
		electrodomesticos[3] = new Lavadora(35, 100000, 8,
							   "blanco", 'A');
		electrodomesticos[4] = new Electrodomestico(100000, 5,
							   "amarillo", 'C');
		electrodomesticos[5] = new Televisor(65, false, 100000, 8,
						       "negro", 'A');
		electrodomesticos[6] = new Lavadora(8, 100000, 4, "azul", 'F');
		electrodomesticos[7] = new Electrodomestico(100000, 2, "rojo", 'B');
		electrodomesticos[8] = new Televisor(29, false, 100000, 4,
							   "negro", 'A');
		 ...
		 * @param precioTotalTelevisor Es el valor total de todos los
		 * Televisores.
		 */
		float precioTotal = 0;
		...
		/**
		 * Es el metodo que recorre el arreglo buscando por medio de instanceof
		 * todos los objetos de tipo Lavadora, Televisor y electrodomesticos 
		 * ademas de verificar los valores totales de cada tipo de objeto.
		 */
		for (int i = 0; i < electrodomesticos.length; i++) {
			...
			if (electrodomesticos[i] instanceof Lavadora) {
				precioTotalLavadora += electrodomesticos[i].precioFinal
						(precioTotal, precioTotalLavadora);
			} else {
				if (electrodomesticos[i] instanceof Televisor) {
					precioTotalTelevisor += electrodomesticos[i].precioFinal
							(precioTotal, precioTotalTelevisor);
